...
const InstaSection = () => {
  ...
  return (
    <section className="pt-24 pb-16 px-28 w-full overflow-hidden" data-aos="zoom-in-up">
...
//     <section className="pt-24 pb-16 px-28" data-aos="zoom-in-up">
//       <div className="container mx-auto pb-12">
//         <div className="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-0 relative">
...
//                   className="w-full h-auto object-cover"
//                 />
//                 <div className="absolute inset-0 bg-gradient-to-t from-purple-500 via-pink-500 to-yellow-500 opacity-0 group-hover:opacity-55 transition-opacity duration-300"></div>
//                 <div className="absolute inset-0 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
