...
const Header = () => {
  ...
  return (
    <header className="bg-gray-100 top-0 z-50 shadow-md">
      <div className="bg-black text-white text-center py-4 text-sm">
        Join and get 10% off! Coupon code: FIRST10
      </div>

    
      <nav className="max-w-7xl mx-auto px-4 lg:px-8 py-5 flex items-center justify-between">
        ...
        <div className="text-lg hidden lg:flex space-x-7 font-semibold">
          <NavLink
            to="/"
            className={({ isActive }) =>
