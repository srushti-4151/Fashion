...
const Header = () => {
  ...
  return (
    <header className="bg-gray-100 sticky top-0 z-50 shadow-md">
      ...
      <nav className="max-w-7xl mx-auto px-4 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-6">
          <NavLink to="/login">
            <button className="border border-gray-300 px-4 py-1 rounded-full text-gray-800 hover:bg-gray-200">
              Login/Sign In
            </button>
          </NavLink>
          <NavLink
          ...
          <NavLink to="/cart" className="text-gray-800 hover:text-yellow-600">
            Cart
          </NavLink>
        </div>
